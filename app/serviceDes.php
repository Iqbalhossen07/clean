...
if (isset($_GET['service_des_id'])) {
    $service_des_id = $_GET['service_des_id'];
    $service_view_id_result = $mysqli->query("SELECT * FROM service_table WHERE id='$service_des_id' ");
    if (!empty($service_view_id_result)) {
        $row = $service_view_id_result->fetch_array();
...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>CleanPro - View Service</title>
        ...
        >
          ...
          >
            <div class="space-y-6">
              <div class="mb-6">
                <img
                  src="service_image/<?php echo $service_image ?>"
                  alt="Service Image"
              ...
              <h2 class="text-3xl font-heading font-bold text-text-dark-high mb-4">
                <?php echo $service_title ?>
              </h2>

              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <p class="text-sm font-medium text-text-dark-medium">Category:</p>
                  <p class="text-lg font-semibold text-text-dark-high"><?php echo $service_category ?></p>
                </div>
             
              </div>

              <div>
                <p class="text-sm font-medium text-text-dark-medium mb-1">Description:</p>
                <p class="text-text-dark-medium leading-relaxed">
