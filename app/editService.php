...
if (isset($_GET['service_update_id'])) {
    $service_update_id = $_GET['service_update_id'];
    $service_update_id_result = $mysqli->query("SELECT * FROM service_table WHERE id='$service_update_id' ");
    if (!empty($service_update_id_result)) {
        $row = $service_update_id_result->fetch_array();
...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>CleanPro - update Service</title>
        ...
        >
          ...
          >
            <form action="logics.php" method="POST" class="space-y-6" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $service_update_id ?>">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    name="service_title" value="<?php echo $service_title ?>"
                    id="title"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="service_category" value="<?php echo $service_category ?>"
                    id="price"
                    step="0.01"
                    class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary focus:border-primary sm:text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                ><?php echo $service_description ?></textarea>
              </div>

              <div class="pt-4">
                <button
                  type="submit" name="udpate_service" 
